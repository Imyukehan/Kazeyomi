...
extension TachideskAPI {
  class RecentChaptersPageQuery: GraphQLQuery {
    static let operationName: String = "RecentChaptersPage"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query RecentChaptersPage($first: Int!, $offset: Int!) { chapters( first: $first offset: $offset filter: { inLibrary: { equalTo: true } } order: [{ by: FETCHED_AT, byType: DESC }, { by: SOURCE_ORDER, byType: DESC }] ) { __typename nodes { __typename id name mangaId fetchedAt isRead lastPageRead isDownloaded scanlator manga { __typename id title thumbnailUrl unreadCount } } pageInfo { __typename hasNextPage hasPreviousPage startCursor endCursor } totalCount } }"#
      ))
    ...
    struct Data: TachideskAPI.SelectionSet {
      ...
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        RecentChaptersPageQuery.Data.self
      ] }
      ...
      struct Chapters: TachideskAPI.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          RecentChaptersPageQuery.Data.Chapters.self
        ] }
        ...
        struct Node: TachideskAPI.SelectionSet {
          ...
          static var __selections: [ApolloAPI.Selection] { [
            ...
            .field("fetchedAt", TachideskAPI.LongString.self),
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            RecentChaptersPageQuery.Data.Chapters.Node.self
          ] }

          var id: Int { __data["id"] }
          var name: String { __data["name"] }
          var mangaId: Int { __data["mangaId"] }
          var fetchedAt: TachideskAPI.LongString { __data["fetchedAt"] }
          ...
          struct Manga: TachideskAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              RecentChaptersPageQuery.Data.Chapters.Node.Manga.self
            ] }
        ...
        struct PageInfo: TachideskAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            RecentChaptersPageQuery.Data.Chapters.PageInfo.self
          ] }
